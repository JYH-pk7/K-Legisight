...
Usage:a
  ...
  python xlsx_to_json_x.py --excel "C:\pythonproject\k_legisight\congress_data\제21대 국회 소위원회 과학기술정보방송통신위원회 회의록 데이터셋.xlsx" --outdir "C:\pythonproject\k_legisight\model_prep\committee_output"
