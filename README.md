...
<p>(최종 수정일: 2025/12/24)</p>
<br></br>

## Database Schema (Supabase)
이 프로젝트는 국회의원 활동 데이터, 발언 분석과 각 위원회의 논제별로 감성 분석한 결과를 효율적으로 관리하기 위해 다음과 같이 설계되었습니다.
...
| | `score` | Float | 감성 분석 점수(찬성/중립/반대) (-1.0 ~ 1.0) |

<br><p>현재 Supabase의 무료 티어 유지 정책으로 인해 데이터베이스는 비활성화 상태입니다(다시 열려면 결제 필요). <p>
