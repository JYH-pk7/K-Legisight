...
8) 만약 발언이 "의사일정 제○항을 상정합니다"에서 곧바로 "수석전문위원(또는 전문위원)께서 내용을 설명해 주시기 바랍니다" 또는 "보고해 주시기 바랍니다"라는 문장을 포함하면, 
   그 발언은 실제 심사 개시로 간주하여 tf_trigger=true, 상정된 안건 항 번호를 agenda_items에 포함한다.

9) "다음" 또는 "먼저"로 시작하며 의사일정 제○항~제○항 구간을 언급하고, 수석전문위원(또는 전문위원)에게 설명이나 보고를 요청하는 발언은, 
   실제로 새로운 안건 심사의 시작으로 간주하여 tf_trigger=true, 해당 항 번호들을 agenda_items에 포함한다.

10) 한 발언 안에서 '의사일정 제○항~제○항 … 상정합니다' 뒤에
    '먼저' 또는 '다음으로'가 이어지고 전문위원에게 설명이나 보고를 요청하면,
    앞의 상정 부분은 무시하고, 뒤쪽 구간을 실제 심사 개시로 간주한다.

11) 한 발언 안에 '의사일정 제○항 … 가결되었음을 선포합니다' 등의 의결 구문이 나온 뒤,
    이어서 '다음' 또는 '먼저'로 시작하며 다른 의사일정 제○항~을 언급하고
    전문위원에게 설명이나 보고를 요청하면,
    앞의 의결 관련 항목은 agenda_items에서 제외하고,
    뒤의 구간만 새로운 심사 구간(tf_trigger=true)으로 간주한다.

12) 발언이 '의사일정 제○항'을 언급하더라도,
    '심사', '설명', '보고' 등의 표현 없이 '의결', '가결', '이의 없으십니까' 등으로만 끝나면
    이미 끝난 안건 처리로 간주하여 tf_trigger=false, agenda_items는 빈 배열로 둔다.

13) 발언에 "수석전문위원님" 또는 "전문위원님"이 등장하고,
    "의사일정 제○항"이 함께 언급되며 "설명하여 주시기 바랍니다" 또는 "설명해 주시기 바랍니다"가 포함되면,
    이는 소위원장이 해당 안건 심사를 개시하는 것으로 간주하여 tf_trigger=true로 판단하고
    언급된 항 번호들을 agenda_items에 포함한다.
...
예시 12) (여러 의사일정 구간을 한 발언에서 함께 심사)
발언:
"다음은 의사일정 제12항부터 제16항 ... 심사하겠습니다.
이 안건의 심사와 관련하여 의사일정 제17항부터 제19항의 남북교류협력법 일부개정법률안에
같은 취지의 내용이 있어 함께 심사하도록 하겠습니다.
전문위원께서 이들 안건의 심사 경과와 주요 내용에 대해 설명해 주시기 바랍니다."
