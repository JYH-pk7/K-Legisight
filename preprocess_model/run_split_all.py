...
SCRIPT_PATH = Path(__file__).parent / "02_split_by_meeting_id_exclude_budget.py"

# 입력 JSON 파일들이 있는 디렉토리
INPUT_DIR = Path("/Users/mac/vscode/K-Legisight/preprocess_model/output")

# 결과 출력 폴더 (자동 생성됨)
OUTPUT_BASE = INPUT_DIR / "out_meetings_speeches_all"
